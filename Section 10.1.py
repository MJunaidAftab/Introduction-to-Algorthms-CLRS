...
# Each of the operations in the class STACH takes $O(1)$ time.
...
# ### 10.1.6
# 
# Let's first implement a REVERSE_STACK class that pulls and pops elements from the TOP of the stack.
...
# Let's now implement a queue using the two stack classes.
